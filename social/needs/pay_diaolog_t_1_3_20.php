	...
	<main>
		...
		<section class="container-lg">
		  ...
		  <div class="cell example example2" id="example-2">
		    ...
		    <div class="p_t_bottom">
   			 <button tyee="submit" data=tid="elements_examples.form.pay_button" class="pri_btn p_t_done">Pay $2.99</button>
			 <a href="#" class="sec_btn p_t_cancel">Cancel</a>
 		    </div>	
