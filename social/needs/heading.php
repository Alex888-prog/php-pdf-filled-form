<body>
   <div class="header">
	...
	<input type="hidden" name="payemail" id="payemail" value="<?php echo $_SESSION['email'] ?>">
	<input type="hidden" name="to" id="to">
	<input type="hidden" name="customerid" id="customerid">
	<input type="hidden" id="elem">
        <input type="text" name="" placeholder="Search Instagram" spellcheck="false" autocomplete="off" class="search form-control" autofocus>
    ...
    <div class="header_right">
      <?php if($universal->isLoggedIn()){ ?>
      <a class="w3-bar-item w3-button w3-right w3-hide-large w3-hover-white w3-large w3-theme-l1" style="top:55px; left: -10px; href="javascript:void(0)" onclick="w3_open()"><i class="fa fa-bars" ></i></a>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <div class="navbar-header">
        ...
        <a class="navbar-brand padding-top-0" href="welcome"><img class="img-responsive" src="<?php echo DIR; ?>/images/logo/logo.PNG"></a>
      </div>
      <a href="<?php echo DIR; ?>"><img src="<?php echo DIR; ?>/images/needs/glyph-instagram.jpg" alt="Instagram"></a>
    </div -->><!--.end of nevbar-header-->
