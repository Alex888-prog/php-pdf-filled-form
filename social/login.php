          ...
          <form method="post" action="" class="login">
            ...
            <div class="form-group">
              <div class="input-group">
                <input type="password" name="s_password" value="" autocomplete="off" placeholder="Password" id="login_password" class="s_password form-control" required maxlength="32"><span class="input-group-addon log_show_psswrd" ><i class="fa fa-lock" aria-hidden="true"></i></span>
              </div>
            </div>

            <div class="form-group">
                <input type="submit" class="btn btn-primary" name="s_submit" value="Log in to continue" class="s_submit">
            </div>

            <div class="bottom-wrap col-md-center">
                <a href="forgot_psswrd" class="a_pri bottom-font" alt="Forgot your password">Forgot your password?</a>
            </div>
            
            
            <div class="bottom-wrap col-md-center">
               <a href="signup" class="bottom-font">Need an account?</a>
            </div>
