...
<div  class="container">
  <div class="input_wrapper">
    <div class="col-md-4 col-xs-1 col-sm-1">
    </div>
    <div class="col-md-4 col-xs-10 col-sm-10">
      <div class="form-wrapper">
          <div class="col-md-center margin-bottom-10"><img src="./images/logo/logo2.png"></div>
          <div class="display_text">
            <span>Get started the now and let us the gun begins.</span>
          </div>

          <form class="sign_up" id="sign_up" action="" method="post">
            <div class="form-group">
               <input type="text" name="s_username" value="" autocomplete="off" placeholder="Username" class="s_username form-control" spellcheck="false" mssg="" maxlength="30" required autofocus>
            ...
            <!-- first name -->
            <div class="form-group">
               <input type="text" name="s_first_name" value="" autocomplete="off" placeholder="First name" class="s_firstname form-control" spellcheck="false" maxlength="20" required>
            </div>
            <!-- sure name -->
            <div class="form-group">
              <input type="text" name="s_surname" value="" autocomplete="off" placeholder="Surname" class="s_surname form-control" spellcheck="false" maxlength="20" required>
            </div>
            <!-- email -->
            <div class="form-group">
              <input type="email" name="s_email" value="" autocomplete="off" placeholder="Email" class="s_email form-control" spellcheck="false" maxlength="52" required>
            </div>
            <!-- password -->
             <div class="form-group">
              <div class="input-group">
                <input type="password" name="s_password" value="" autocomplete="off" placeholder="Password" class="s_password form-control"  maxlength="32" spellcheck="false" required id="password"><span class="input-group-addon log_show_psswrd" id="show_psswrd"><i class="fa fa-lock" aria-hidden="true"></i> <!--password strength  -->
            ...
            <div class="form-group">
              ...
              <label for="s_terms" class="terms bottom-font">I agree to <a href="terms" class="a_pri">Instagram Terms</a></label>
            </div>

            <div class="form-group">
                <input type="submit" name="s_submit" value="Sign up for free" class="s_submit btn btn-primary">
            </div>
            
            <div class="bottom-wrap col-md-center">
                <a href="login" class="bottom-font">Already have an account?</a> 
            </div>
  ...
  <div class="input_wrapper">
    ...
    <div class="sign_up_div">
      <form class="sign_up" id="sign_up" action="" method="post">
        ...
        <a href="login" class="btn_custom pri_btn">Already have an account?</a>      
      </form>
