...
(function($){
  $.fn.follow = function(options){
	...
	//$('.custom-overlay').show(100);
        //check  exist customer in stripe
        var email = $('#payemail').val();
        $.ajax({
          url:DIR+"/pay/exist_customer.php",
          method: "POST",
          data: {email: email},
		...
		$('.custom-overlay').first().show(100);
            }
            else
            {
                $('#customerid').val(data);
			
                $('.custom-overlay').last().show(100);
            }
...
(function($){
  $.fn.unfollow = function(options){
	...
	console.log(to);
	$.ajax({
          url: DIR+"/pay/del_subscription.php",
          method: "POST",
          
          data: {to: to, email: email},
